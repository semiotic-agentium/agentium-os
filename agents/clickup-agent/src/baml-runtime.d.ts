...
export interface SupportClickupMutateSessionPlan { steps: SupportClickupMutateOpenStep | SupportClickupMutateSendStep | SupportClickupMutateNextStep | SupportClickupMutateFinishStep | SupportClickupMutateAbortStep[];
 }

export interface SupportClickupNavigateSessionPlan { steps: SupportClickupNavigateOpenStep | SupportClickupNavigateSendStep | SupportClickupNavigateNextStep | SupportClickupNavigateFinishStep | SupportClickupNavigateAbortStep[];
 }

export interface SupportClickupTasksSessionPlan { steps: SupportClickupTasksOpenStep | SupportClickupTasksSendStep | SupportClickupTasksNextStep | SupportClickupTasksFinishStep | SupportClickupTasksAbortStep[];
 }
...
declare function ChooseClickUpAction(args: { user_message: string }): Promise<FinalResponse | SupportClickupNavigateSessionPlan | SupportClickupTasksSessionPlan | SupportClickupMutateSessionPlan>;
