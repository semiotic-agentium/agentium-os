...
export type ToolName = "support/clickup";
...
declare function openSupportClickupSession(): Promise<ToolSession<ToolInput<"support/clickup">, ToolOutput<"support/clickup">>>;
