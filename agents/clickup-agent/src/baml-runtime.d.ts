...
export interface SupportClickupSessionPlan { steps: SupportClickupOpenStep | SupportClickupSendStep | SupportClickupNextStep | SupportClickupFinishStep | SupportClickupAbortStep[];
reason: string | null;
 }
...
declare function ChooseClickUpAction(args: { user_message: string } & { __baml_invocation_token?: string }): Promise<FinalResponse | SupportClickupSessionPlan>;
