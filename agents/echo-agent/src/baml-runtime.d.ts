...
export interface DevEchoAbortStep { op: "Abort";
 }

export interface DevEchoFinishStep { op: "Finish";
 }

export interface DevEchoInput { message: string;
panic: boolean | null;
pollute: boolean | null;
 }

export interface DevEchoOpenStep { op: "Open";
tool_name: "dev/echo";
 }

export interface DevEchoPageReadStep { op: "PageRead";
input: ArchivePageReadInput;
 }

export interface DevEchoSearchReadStep { op: "SearchRead";
input: ArchiveSearchReadInput;
 }

export interface DevEchoSendStep { op: "Send";
input: DevEchoInput;
citations: string[];
 }

export interface DevEchoSessionPlan { step: DevEchoOpenStep | DevEchoSendStep | DevEchoSearchReadStep | DevEchoPageReadStep | DevEchoFinishStep | DevEchoAbortStep;
citations: string[];
 }
...
declare function ChooseEchoAgentAction(args: { user_message: string } & { __baml_invocation_token?: string }): Promise<DevEchoSessionPlan>;

declare function PresentEchoAgentReply(args: { user_message: string } & { __baml_invocation_token?: string }): Promise<StructuredReply>;
...
export type StepExecutorFunctionName = "ChooseEchoAgentAction" | "ChooseEchoAgentAction__act__dev_echo" | "ChooseEchoAgentAction__continue__dev_echo" | "ChooseEchoAgentAction__select";
...
export interface StepExecutorFunctionMap {
  ChooseEchoAgentAction: { args: Parameters<typeof ChooseEchoAgentAction>[0] & StepExecutorStateInput; result: Awaited<ReturnType<typeof ChooseEchoAgentAction>>; };
  ChooseEchoAgentAction__act__dev_echo: { args: Parameters<typeof ChooseEchoAgentAction__act__dev_echo>[0] & StepExecutorStateInput; result: Awaited<ReturnType<typeof ChooseEchoAgentAction__act__dev_echo>>; };
  ChooseEchoAgentAction__continue__dev_echo: { args: Parameters<typeof ChooseEchoAgentAction__continue__dev_echo>[0] & StepExecutorStateInput; result: Awaited<ReturnType<typeof ChooseEchoAgentAction__continue__dev_echo>>; };
  ChooseEchoAgentAction__select: { args: Parameters<typeof ChooseEchoAgentAction__select>[0] & StepExecutorStateInput; result: Awaited<ReturnType<typeof ChooseEchoAgentAction__select>>; };
}
