...
export interface McpMeteoGetMeteoAbortStep { op: "Abort";
 }

export interface McpMeteoGetMeteoFinishStep { op: "Finish";
 }

export interface McpMeteoGetMeteoInput { location_query: string;
city: string | null;
country: string | null;
...
export interface McpMeteoGetMeteoOpenStep { op: "Open";
tool_name: "mcp/meteo/get_meteo";
 }

export interface McpMeteoGetMeteoPageReadStep { op: "PageRead";
input: ArchivePageReadInput;
 }

export interface McpMeteoGetMeteoSearchReadStep { op: "SearchRead";
input: ArchiveSearchReadInput;
 }

export interface McpMeteoGetMeteoSendStep { op: "Send";
input: McpMeteoGetMeteoInput;
citations: string[];
 }

export interface McpMeteoGetMeteoSessionPlan { step: McpMeteoGetMeteoOpenStep | McpMeteoGetMeteoSendStep | McpMeteoGetMeteoSearchReadStep | McpMeteoGetMeteoPageReadStep | McpMeteoGetMeteoFinishStep | McpMeteoGetMeteoAbortStep;
citations: string[];
 }
...
declare function ChooseMeteoAgentAction(args: { user_message: string } & { __baml_invocation_token?: string }): Promise<McpMeteoGetMeteoSessionPlan>;

declare function PresentMeteoAgentReply(args: { user_message: string } & { __baml_invocation_token?: string }): Promise<StructuredReply>;
...
export type StepExecutorFunctionName = "ChooseMeteoAgentAction" | "ChooseMeteoAgentAction__act__mcp_meteo_get_meteo" | "ChooseMeteoAgentAction__continue__mcp_meteo_get_meteo" | "ChooseMeteoAgentAction__select";
...
export interface StepExecutorFunctionMap {
  ...
  ChooseMeteoAgentAction__act__mcp_meteo_get_meteo: { args: Parameters<typeof ChooseMeteoAgentAction__act__mcp_meteo_get_meteo>[0] & StepExecutorStateInput; result: Awaited<ReturnType<typeof ChooseMeteoAgentAction__act__mcp_meteo_get_meteo>>; };
  ChooseMeteoAgentAction__continue__mcp_meteo_get_meteo: { args: Parameters<typeof ChooseMeteoAgentAction__continue__mcp_meteo_get_meteo>[0] & StepExecutorStateInput; result: Awaited<ReturnType<typeof ChooseMeteoAgentAction__continue__mcp_meteo_get_meteo>>; };
