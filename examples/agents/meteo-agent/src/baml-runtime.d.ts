...
export interface DevMeteoToolAbortStep { op: "Abort";
 }

export interface DevMeteoToolFinishStep { op: "Finish";
 }

export interface DevMeteoToolInput { location_query: string;
city: string | null;
country: string | null;
...
export interface DevMeteoToolOpenStep { op: "Open";
tool_name: "dev/meteo-tool";
 }

export interface DevMeteoToolPageReadStep { op: "PageRead";
input: ArchivePageReadInput;
 }

export interface DevMeteoToolSearchReadStep { op: "SearchRead";
input: ArchiveSearchReadInput;
 }

export interface DevMeteoToolSendStep { op: "Send";
input: DevMeteoToolInput;
citations: string[];
 }

export interface DevMeteoToolSessionPlan { step: DevMeteoToolOpenStep | DevMeteoToolSendStep | DevMeteoToolSearchReadStep | DevMeteoToolPageReadStep | DevMeteoToolFinishStep | DevMeteoToolAbortStep;
citations: string[];
 }
...
declare function ChooseMeteoAgentAction(args: { user_message: string } & { __baml_invocation_token?: string }): Promise<DevMeteoToolSessionPlan>;
