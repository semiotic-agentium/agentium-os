...
fn storage_safe_key(key: &str) -> String {
    let s: &'static str = match key {
        ...
        a2a::DRIFT_MODE => storage_safe::A2A_DRIFT_MODE,
        a2a::DRIFT_WARN_MIN_SCORE => storage_safe::A2A_DRIFT_WARN_MIN_SCORE,
        a2a::DRIFT_BLOCK_MIN_SCORE => storage_safe::A2A_DRIFT_BLOCK_MIN_SCORE,
        a2a::INTENT_TEXT_PREVIEW => storage_safe::A2A_INTENT_TEXT_PREVIEW,
        a2a::RESPONSE_TEXT_PREVIEW => storage_safe::A2A_RESPONSE_TEXT_PREVIEW,
