...
///
/// **`rootDir`** is required explicitly: TypeScript 5.6+ / TS 6 treats the inferred
/// common source directory (`./src` from `include`) as an error unless `rootDir`
/// is set (TS5011). See <https://aka.ms/ts6> migration notes.
