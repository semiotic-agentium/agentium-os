...
- **Static span names**: `baml_rt_api.list_agents`, `baml_rt_api.post_a2a_sse` (namespace prefix, low cardinality).
...
- **Structured attributes**: `route` (list_agents, post_a2a_sse) and `result` (success, error); low cardinality.
