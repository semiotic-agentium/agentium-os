...
- **Intent/plan prompting:** `docs/assertions/intent-based-planning-and-session-prompting.md` (same contract in operator-facing guidance: citations → citable history + checked provenance).
- Drift / injection framing: `docs/assertions/drift-catalogue.md`
