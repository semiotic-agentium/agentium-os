...
export interface SupportCalculatePageReadStep { op: "PageRead";
input: ArchivePageReadInput;
 }

export interface SupportCalculateSearchReadStep { op: "SearchRead";
...
export interface SupportCalculateSessionPlan { step: SupportCalculateOpenStep | SupportCalculateSendStep | SupportCalculateSearchReadStep | SupportCalculatePageReadStep | SupportCalculateFinishStep | SupportCalculateAbortStep;
citations: string[];
 }

export interface UnifiedHarnessAsk { action: string;
question: string;
 }

export interface UnifiedHarnessPlan { goal: string;
nodes: UnifiedHarnessPlanNode[];
 }

export interface UnifiedHarnessPlanNode { id: string;
kind: string;
depends_on: string[];
 }
...
declare function UnifiedHarnessPick(args: { user_message: string } & { __baml_invocation_token?: string }): Promise<UnifiedHarnessPlan | UnifiedHarnessAsk>;
