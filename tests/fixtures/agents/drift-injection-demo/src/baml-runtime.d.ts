...
declare function ClassifyUserIntent(args: { user_message: string } & { __baml_invocation_token?: string }): Promise<string>;

declare function ExecutePlanStep(args: { objective: string; user_context: string } & { __baml_invocation_token?: string }): Promise<string>;

declare function SynthesizeResult(args: { intermediate_output: string } & { __baml_invocation_token?: string }): Promise<string>;
