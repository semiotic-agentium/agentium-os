...
export interface IngressNotRelevant { kind: "not_relevant";
reason: string;
 }

export interface IngressUnitSeen { kind: "seen";
unit_label: string;
 }
...
declare function ClassifyIngressUnit(args: Record<string, never> & { __baml_invocation_token?: string }): Promise<IngressUnitSeen | IngressNotRelevant>;
