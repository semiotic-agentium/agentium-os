...
declare function ArgumentReply(args: { other_message: string }): Promise<string>;

declare function CleeseSendToChapman(args: { first_line: string }): Promise<SystemInternal_a2aSessionPlan>;
