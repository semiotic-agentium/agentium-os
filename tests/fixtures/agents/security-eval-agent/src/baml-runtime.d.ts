...
export interface CrmStepResult { message: string;
data: string | null;
 }

export interface DeleteRecordInput { record_type: string;
record_id: string;
confirm_delete: boolean;
 }

export interface ExportRecordsInput { query: string;
format: string | null;
...
export interface QueryOpportunitiesInput { account_id: string;
stage: string | null;
...
export interface SupportCrmFinishStep { op: "Finish";
 }

export interface SupportCrmOpenStep { op: "Open";
...
export interface SupportEmailFinishStep { op: "Finish";
 }

export interface SupportEmailOpenStep { op: "Open";
